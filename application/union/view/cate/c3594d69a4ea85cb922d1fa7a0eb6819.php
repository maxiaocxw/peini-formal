<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:56:"D:\pei\public/../application/index\view\money\index.html";i:1563178889;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="weadmin-body" id="header">
    <div id="Layer1" style="position:fixed; left:0px; top:0px; width:100%; height:100%">
        <img src="http://cdn.lanyushiting.com/mmm.png" width="100%" height="100%"/>
    </div>
    <div class="layui-form-item">
        <div class="layui-input-block">
            <h1><font color="red">城市网吧代理提交</font></h1>
        </div>
    </div>
