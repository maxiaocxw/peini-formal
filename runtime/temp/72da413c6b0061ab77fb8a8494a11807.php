<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:93:"D:\phpserver\wwwroot\default\peini-formal\public/../application/admin\view\cate\gametype.html";i:1562569201;}*/ ?>
<!DOCTYPE html>
<html>
        ...
        <table class="layui-table">
            ...
            <tbody>
                <?php foreach($data as $key => $value): ?>
                    ...
                    <td class="td-manage">
                        <a title="修改"  href="/admin/cate/updateGametypes/tid/<?php echo $value['tid']; ?>"><button class="layui-btn layui-btn-normal layui-btn-sm">修改</button></a>
                        <?php if(($value['status'] == 1)): ?>
