<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:89:"D:\phpserver\wwwroot\default\peini-formal\public/../application/admin\view\tag\index.html";i:1562569305;}*/ ?>
<!DOCTYPE html>
<html>
        ...
        <table class="layui-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="td-manage">
                        <a title="修改"  href="/admin/tag/update/lid/<?php echo $value['lid']; ?>"><button class="layui-btn layui-btn-normal layui-btn-sm">修改</button></a>
