<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:90:"D:\phpserver\wwwroot\default\peini-formal\public/../application/admin\view\admin\role.html";i:1562317673;}*/ ?>
<!DOCTYPE html>
<html>
...
<body>
    ...
    <div class="weadmin-body">
        ...
        <div class="weadmin-block">
            ...
            <a href="<?php echo url('admin/admin/addRole'); ?>">
        ...
        <table class="layui-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="td-manage">
                        <a title="删除" onclick="delRole(<?php echo $value['id']; ?>)" href="javascript:;"><button class="layui-btn layui-btn-danger layui-btn-sm">删除</button></a>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
    ...
    function delRole(id) {
        $.post("/admin/admin/delRole", { id: id }, function(data) {
            layer.msg(data.msg, { time: 1000, icon: data.icon }, function() {
                location.href = "<?php echo url('admin/admin/role'); ?>";
            })
        }, 'json');
    }
    ...
    function delAll() {
        ...
        layer.confirm('确认要删除吗？', function(index) {
            ...
            $.post("<?php echo url('admin/admin/delAll'); ?>", { id: data, table: 'role' }, function(response) {
