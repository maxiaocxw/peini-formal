<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:93:"D:\phpserver\wwwroot\default\peini-formal\public/../application/admin\view\cate\interest.html";i:1562567533;}*/ ?>
<!DOCTYPE html>
<html>
...
<body>
        ...
        <table class="layui-table">
            ...
            <tbody>
                <?php foreach($data as $key => $value): ?>
                    ...
                    <td class="td-manage">
                        <a title="修改"  href="/admin/cate/updateInterests/nid/<?php echo $value['nid']; ?>"><button class="layui-btn layui-btn-normal layui-btn-sm">修改</button></a>
                        <?php if(($value['status'] == 1)): ?>
    ...
    function updateInterests(id) {
        $.post("<?php echo url('admin/cate/updateInterests'); ?>", { nid: id }, function(data) {
            layer.msg(data.msg, { time: 1000, data:icon }, function() {
                location.reload();
            })
        }, 'json');
