<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"D:\pei\public/../application/admin\view\banner\add_article_banner.html";i:1554983222;}*/ ?>
<!DOCTYPE html>
<html>
...
<body>
    ...
    layui.use(['form', 'layer', 'admin', 'upload'], function() {
        ...
        form.on('submit(add)', function(data) {
            ...
            $.ajax({
                url: "<?php echo url('addArticleBanner'); ?>",
                type: 'post',
                data: data.field,
                dataType: 'json',
